...
/* Begin PBXFileReference section */
		A10000030000000000000001 /* LatticeTplApp.app */ = {isa = PBXFileReference; explicitFileType = wrapper.application; includeInIndex = 0; path = LatticeTplApp.app; sourceTree = BUILT_PRODUCTS_DIR; };
		A10000020000000000000001 /* LatticeTplAppApp.swift */ = {isa = PBXFileReference; lastKnownFileType = sourcecode.swift; path = LatticeTplAppApp.swift; sourceTree = "<group>"; };
...
/* Begin PBXResourcesBuildPhase section */
		A100000B0000000000000001 /* Resources */ = {
...
/* Begin PBXGroup section */
		A10000050000000000000001 = {
			isa = PBXGroup;
			children = (
				A10000050000000000000002 /* LatticeTplApp */,
		...
		A10000050000000000000002 /* LatticeTplApp */ = {
			...
			children = (
				...
				A10000020000000000000001 /* LatticeTplAppApp.swift */,
		...
		A10000050000000000000003 /* Products */ = {
			isa = PBXGroup;
			children = (
				A10000030000000000000001 /* LatticeTplApp.app */,
			);
			name = Products;
			sourceTree = "<group>";
		};
...
/* Begin PBXNativeTarget section */
		A10000060000000000000001 /* LatticeTplApp */ = {
			isa = PBXNativeTarget;
			buildConfigurationList = A10000090000000000000001 /* Build configuration list for PBXNativeTarget "LatticeTplApp" */;
			buildPhases = (
			...
			name = LatticeTplApp;
			productName = LatticeTplApp;
			productReference = A10000030000000000000001 /* LatticeTplApp.app */;
...
/* Begin PBXProject section */
		A10000080000000000000001 /* Project object */ = {
			...
			buildConfigurationList = A10000090000000000000002 /* Build configuration list for PBXProject "LatticeTplApp" */;
...
/* Begin PBXSourcesBuildPhase section */
		A10000070000000000000001 /* Sources */ = {
			...
			buildActionMask = 2147483647;
			files = (
				A10000010000000000000001 /* LatticeTplAppApp.swift in Sources */,
...
/* Begin XCBuildConfiguration section */
		A100000A0000000000000001 /* Debug */ = {
		...
		A100000A0000000000000002 /* Release */ = {
			isa = XCBuildConfiguration;
			buildSettings = {
				ALWAYS_SEARCH_USER_PATHS = NO;
				CLANG_ENABLE_MODULES = YES;
		...
		A100000A0000000000000003 /* Debug */ = {
			...
			buildSettings = {
				...
				INFOPLIST_KEY_CFBundleDisplayName = LatticeTplApp;
				...
				PRODUCT_BUNDLE_IDENTIFIER = com.lattice.template.LatticeTplApp;
		...
		A100000A0000000000000004 /* Release */ = {
			isa = XCBuildConfiguration;
			buildSettings = {
				ASSETCATALOG_COMPILER_APPICON_NAME = AppIcon;
				CODE_SIGN_STYLE = Automatic;
...
/* Begin XCConfigurationList section */
		A10000090000000000000001 /* Build configuration list for PBXNativeTarget "LatticeTplApp" */ = {
		...
		A10000090000000000000002 /* Build configuration list for PBXProject "LatticeTplApp" */ = {
			isa = XCConfigurationList;
			buildConfigurations = (
				A100000A0000000000000001 /* Debug */,
				A100000A0000000000000002 /* Release */,
