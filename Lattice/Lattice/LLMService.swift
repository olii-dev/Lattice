...
struct LLMService {
    ...
    static func latticeSystemPrompt(for context: ChatContext) -> String {
        ...
        - When the user asks for an Apple capability, use the add_capability tool. Supported capabilities: app_groups, push_notifications, storekit, keychain_sharing, background_modes, swiftdata, cloudkit_sync, healthkit, app_intents. The tool handles entitlements, Info.plist keys, seed files, and project build settings correctly and idempotently.
